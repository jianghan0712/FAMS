...
public class MdStockSnapshotTempBO extends BaseBO {
	...
	public List<Double> buyPriceList = new ArrayList<Double>();// 五档买行情，买一->买五，以^做隔断

	public List<Long> buyQtyList = new ArrayList<Long>();// 五档买挂单量，买一->买五，以^做隔断

	public List<Double> sellPriceList = new ArrayList<Double>();// 五档买行情，卖五->卖一，以^做隔断

	public List<Long> sellQtyList = new ArrayList<Long>();// 五档卖挂单量，卖五->卖一，以^做隔断
